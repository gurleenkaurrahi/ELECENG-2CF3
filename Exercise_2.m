% Exercise 2 - Gurleen Rahi - 400377038 - rahig
...
Lamda = vp/f;             
T = (2*pi)/Omega;         % Formula for time period
...
sinusoid = @(tau) A*cos(Omega*tau);       % function for sinusoidal
wave = @(z, ti) sinusoid(ti - z / vp);    % function for wave

% plots specification
subplot(3, 1, 1)                                  % 3x1 grid, 1st plot
line1 = animatedline('Color', 'red');             % line in the plot
title("Sinusoidal pulse traveling in +z direction") % title
